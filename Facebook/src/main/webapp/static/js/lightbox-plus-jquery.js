...
/*
 * ! Lightbox v2.8.2 by Lokesh Dhakar
 * 
	...
	if (typeof define === 'function' && define.amd) {
		...
		(
				...
				function($) {
					...
					// Loop through anchors and areamaps looking for either
					// data-lightbox attributes or rel attributes
					// that contain 'lightbox'. When these are clicked, start
					// lightbox.
					...
					// Attach event handlers to the new DOM elements. click
					// click click
					Lightbox.prototype.build = function() {
						var self = this;
					
						$(
								'<div id="lightboxOverlay" class="lightboxOverlay"></div><div id="lightbox" class="lightbox"><div class="lb-dataContainer"><div class="lb-data"><div class="lb-details"><span class="lb-caption"></span></div><div class="lb-closeContainer"><a class="lb-close1"></a></div></div></div><div class="lb-outerContainer"><div class="lb-container"><img class="lb-image" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" /><div class="lb-nav"><a class="lb-prev" href="" ></a><a class="lb-next" href="" ></a></div><div class="lb-loader"><a class="lb-cancel"></a></div></div></div><div class="lb-dataContainer"><div class="lb-data"><div class="lb-details"><span class="lb-caption"></span><span class="lb-number"></span></div><div class="lb-closeContainer"><a class="lb-delete" href="/deletePic/" ><span class="glyphicon glyphicon-trash" style="font-size:20px;"></span></a></div></div></div></div>')
								.appendTo($('body'));
						// Cache jQuery objects
						this.$lightbox = $('#lightbox');
						this.$overlay = $('#lightboxOverlay');
						this.$outerContainer = this.$lightbox
						...
						// Attach event handlers to the newly minted DOM
						// elements
						...
						this.$lightbox.find('.lb-loader, .lb-close, .lb-close1').on(
								'click', function() {
									self.end();
									return false;
								});
					...
					// Show overlay and lightbox. If the image is part of a set,
					// add siblings to album array.
					Lightbox.prototype.start = function($link) {
						...
						var d =''+ $link.attr('pic-id');
						
						this.$lightbox.find('.lb-delete').on(
								'click', function() {
			
								        location.href = ('deletePic/' + d);
								   
								});

						// Support both data-lightbox attribute and rel
						...
						if (dataLightboxValue) {
							$links = $($link.prop('tagName')
									+ '[data-lightbox="' + dataLightboxValue
									+ '"]');
					...
					// Hide most UI elements in preparation for the animated
					...
					Lightbox.prototype.changeImage = function(imageNumber) {
						...
						// When image to show is preloaded, we send the width
						// and height to sizeContainer()
						...
						preloader.onload = function() {
							...
							if (self.options.fitImagesInViewport) {
								...
								// Take into account the border around the image
								// and an additional 10px gutter on each side.
					...
					Lightbox.prototype.sizeOverlay = function() {
						this.$overlay.width($(document).width()).height(
								$(document).height());
					};

					// Animate the size of the lightbox to fit the image we are
					// showing
					Lightbox.prototype.sizeContainer = function(imageWidth,
							imageHeight) {
						var self = this;
						...
						function postResize() {
							self.$lightbox.find('.lb-dataContainer').width(
									newWidth);
							self.$lightbox.find('.lb-prevLink').height(
									newHeight);
							self.$lightbox.find('.lb-nextLink').height(
									newHeight);
							self.showImage();
						}
					...
					// Display the image and its details and begin preload
					// neighboring images.
					...
					Lightbox.prototype.updateNav = function() {
						// Check to see if the browser supports touch events. If
						// so, we take the conservative approach
						// and assume that mouse hover events are not supported
						// and always show prev/next navigation
						...
						if (this.album.length > 1) {
							if (this.options.wrapAround) {
								...
								if (this.currentImageIndex > 0) {
									...
									if (alwaysShowNav) {
										this.$lightbox.find('.lb-prev').css(
												'opacity', '1');
									}
								}
								if (this.currentImageIndex < this.album.length - 1) {
									...
									if (alwaysShowNav) {
										this.$lightbox.find('.lb-next').css(
												'opacity', '1');
									}
								}
							}
